...
class TransmittingIcon {
    ...
    private static final ResourceLocation NOT_TRANSMITTING = rs("transmitting/0");
    private static final ResourceLocation TRANSMITTING_1 = rs("transmitting/1");
    private static final ResourceLocation TRANSMITTING_2 = rs("transmitting/2");
    private static final ResourceLocation TRANSMITTING_3 = rs("transmitting/3");
    ...
    private static ResourceLocation rs(final String path) {
        return ResourceLocation.fromNamespaceAndPath("refinedstorage", path);
    }
