...
/**
 * Balm-backed config (replaces the NeoForge {@code ModConfigSpec} so the values are readable from loader-neutral code).
 * Same defaults as before — Kitchen Station 8 (RS Network Receiver), Access Point 32 (RS Network Transmitter).
 */
