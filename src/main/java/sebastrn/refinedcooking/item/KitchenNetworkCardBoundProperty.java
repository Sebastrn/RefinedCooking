 ...
 * {@code NetworkCardItemPropertyFunction} is the model; this is the RC equivalent. Registered in {@code ClientSetup};
 * the {@code models/item/kitchen_network_card.json} overrides select on {@link #NAME}.
 */
